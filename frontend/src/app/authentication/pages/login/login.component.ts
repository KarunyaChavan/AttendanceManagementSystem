...
export class LoginComponent implements OnInit {
  ...
  submitForm() {
    if (this.isStudent && this.studentLoginForm.valid) {
      this.authServices.studentLogin(this.studentLoginForm.value)
        .subscribe((response) => {
          if (response.success) {
            this.storeLogin(response, true);
          }
    ...
    else if (!this.isStudent && this.teacherLoginForm.valid) {
      this.authServices.teacherLogin(this.teacherLoginForm.value)
        .subscribe((response) => {
          if (response.success) {
            this.storeLogin(response, false);
          }
